...
The reference catalogs we use are drawn entirely from OpenStreetMap and are independent of the Miller–Broadhurst tradition: 754 St Michael place-of-worship records, 2422 strict prehistoric and Iron-Age monuments, and 5500 broader archaeological records. The canonical corridor is defined by the great circle through the best site pair from a 130-site KML extraction of the alignment (Anonymous 2017).
